...
########### 循环
setwd('/home/wus/2023-2-23_008_TCGAbiolinks_download/box-USP33/')
...
#### 基因名转换
gene_id<-rowData(data)[rowData(data)$gene_name=="USP33",'gene_id']
print(gene_id)
...
bxp+
    scale_color_manual(values = c( "#0b5d0a","#9a0000"))+ 
 theme(axis.text.x = element_text(angle=45, hjust=1, vjust=1))+ylab("USP33_TPM")  + ylim(0,130)
